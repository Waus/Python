input_file_path = r'C:\Git\Python\Pliki testowe input\duza tabela.txt'  # ścieżka do pliku wejściowego
output_file_path = r'C:\Git\Python\Pliki testowe output\duza tabela.txt'  # ścieżka, gdzie zostanie zapisany plik wyjściowy
